...
RSpec.describe AnimalsController, type: :controller do
  let(:zoo) { FactoryGirl.create :zoo, name: "Tunt Zoo" }
  let(:species) { FactoryGirl.create :species, name: "Ocelot" }

  # This should return the minimal set of attributes required to create a valid
  # Animal. As you add validations to Animal, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    {name: "Baboo", zoo_id: zoo.id, species_id: species.id}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:kgb_zoo) { FactoryGirl.create :zoo, name: "Московский зоопарк" }
      let(:kgb_species) { FactoryGirl.create :species, name: "Оцелот"}
      let(:new_attributes) {
        {name: "Дмитрий", zoo_id: kgb_zoo.id, species_id: kgb_species.id}
      }
